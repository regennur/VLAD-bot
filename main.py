...
def start(update, context):
    ...
    update.message.reply_text(
        ...
        --------------------------------------------------------
        ‼️ /remind - установить напоминание, чтобы я мог законно тебя донимать 
        --------------------------------------------------------
         """)
...
def help(update, context):
    update.message.reply_text(
        ...
        😶 и наконец, ответ на ВСЕ твои В❔ПР❔СЫ:

         С точки зрения банальной эрудиции, каждый индивидуум, критически мотивирующий абстракцию, 
         ...
         всеобщих мотиваций в парадигматических связях предикатов,
         решает проблему усовершенствования формирующих геотрансплантационных квазипузлистатов всех кинетически кореллирующих аспектов
         """)
...
def timee(update, context):
    ...
    update.message.reply_text('🕗 ' + td[11:19])
